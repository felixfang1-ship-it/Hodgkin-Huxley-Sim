...
function updateUI() {
  ...
  if (sodiumAutoClosed && sodiumState === 'closed') {
    ...
    sodiumExplanationEl.innerHTML += ' Intracellular Na<sup>+</sup> buildup slowed the flux and forced the channel closed. Once the channel repolarized it will reopen.';
  }
  ...
  if (potassiumAutoClosed && potassiumState === 'closed') {
    ...
    potassiumExplanationEl.innerHTML += ' Extracellular K<sup>+</sup> buildup slowed the flux and forced the channel closed. Once the channel repolarized it will reopen.';
  }
